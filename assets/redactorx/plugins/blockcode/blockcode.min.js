RedactorX.add("plugin", "blockcode", {
  ...
  defaults: {
    ...
    popup: {
      ...
      form: { code: { type: "textarea", rows: "8" } },
      footer: {
        save: {
  ...
  edit: function () {
    var t = this._getCurrent(),
      e = t.getOuterHtml();
    (e = this.app.parser.unparse(e)),
      t.isEditable() && (this.offset = this.app.offset.get(t.getBlock())),
      this.app.popup.create("code", this.opts.blockcode.popup),
      this.app.popup.setData({ code: e }),
  ...
  save: function () {
    ...
    var t = this._getCurrent(),
      e = this._getCode();
    if ("" !== e) {
      e = this.app.parser.parse(e, !1);
      var o = this.dom(e),
        p = this.app.create("block." + t.getType(), o);
      t.change(p),
        this.offset &&
          p.isEditable() &&
          this.app.offset.set(p.getBlock(), this.offset),
        (this.offset = !1);
    }
  },
  _getCurrent: function () {
    var t = this.app.block.get();
    return t.isSecondLevel() && (t = t.getFirstLevel()), t;
  },
  _getCode: function () {
  ...
  _buildInputHandle: function () {
    this.app.popup
      .getInput("code")
      .on("keydown", this.app.input.handleTextareaTab.bind(this));
  },
  _buildCodemirror: function () {
    var t = this.app.popup.getInput("code");
    this.app.codemirror.create({ el: t, height: "200px", focus: !0 }),
