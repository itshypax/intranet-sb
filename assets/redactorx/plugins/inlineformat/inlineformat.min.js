RedactorX.add("plugin", "inlineformat", {
  ...
  popup: function (t, i) {
    for (
      var e = this.opts.inlineformat.items,
        n = this.app.selection.getNodes({ type: "inline" }),
        a = {},
        o = 0;
      o < e.length;
      o++
      ...
      var r = e[o];
      (a[r] = this.opts.inlineformat.itemsObj[r]),
        (a[r].command = "inline.set");
    }
    0 !== n.length &&
      (a.remove = {
      ...
      this.app.popup.create("inlineformat", { width: "300px", items: a }),
