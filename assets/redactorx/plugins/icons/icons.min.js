RedactorX.add("plugin", "icons", {
  translations: { en: { icons: { icons: "Icons" } } },
  defaults: {
  ...
  start: function () {
    ...
    this.app.toolbar.add("icons", s);
  },
  popup: function (s, h) {
    for (var t = {}, c = this.opts.icons.items, v = 0; v < c.length; v++)
      t[v] = {
        html: this.dom("<div>")
    ...
    this.app.popup.create("icons", { type: "grid", width: "160px", items: t }),
      this.app.popup.open({ button: h });
  },
  insert: function (s) {
    this.app.popup.close(), this.app.insertion.insertHtml(s.icon, "after");
  },
});
