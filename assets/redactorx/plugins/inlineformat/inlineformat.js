RedactorX.add("plugin", "inlineformat", {
  ...
  defaults: {
    ...
    itemsObj: {
      u: {
        title:
          '<span style="text-decoration: underline;">## inlineformat.underline ##</span>',
        params: { tag: "u" },
        shortcut: "Ctrl+u",
      },
      sup: {
      ...
      mark: {
        title:
          '<span style="background: yellow;">## inlineformat.mark ##</span>',
        params: { tag: "mark" },
      },
      code: {
        title:
          '<span style="font-family: monospace; background: #f0f1f2; padding: 4px;">## inlineformat.code ##</span>',
        params: { tag: "code" },
      },
      kbd: {
