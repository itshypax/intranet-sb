                    ...
                    <table class="table table-striped" id="table-uploads">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<td><a title='https://intra.stettbeck.de/assets/upload/" . $row['file_name'] . "' href='/assets/upload/" . $row['file_name'] . "' class='btn btn-sm btn-primary'><i class='fa-solid fa-link'></i></a></td>";
                                echo "</tr>";
                            }
                            ?>
                        </tbody>
