                    ...
                    <table class="table table-striped" id="test-table">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<td >" . $row['id'] . "</td>";
                                if ($row['used'] == 0) {
                                    echo "<td><a href='https://intra.stettbeck.de/frsrd/test?code=" . $row['hash'] . "' class='copy-link' style='text-decoration:none'>" . $row['hash'] .  " <i class='fa-solid fa-copy fa-2xs'></i></a></td>";
                                } else {
