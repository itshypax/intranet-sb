RedactorX.add("plugin", "textdirection", {
  ...
  toggle: function (t, i) {
    var e = this.app.block.get().getBlock().attr("dir"),
      o = {
        ltr: { title: "## textdirection.ltr ##", command: "textdirection.set" },
        rtl: { title: "## textdirection.rtl ##", command: "textdirection.set" },
      };
    (o[e || this.opts.editor.direction].active = !0),
      this.app.popup.create("textdirection", { items: o }),
      this.app.popup.open({ button: i });
  },
  set: function (t, i, e) {
    this.app.popup.close();
    var o = this.app.block.get().getBlock();
    this.opts.editor.direction === e ? o.removeAttr("dir") : o.attr("dir", e);
  },
});
