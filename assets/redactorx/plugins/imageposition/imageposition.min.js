RedactorX.add("plugin", "imageposition", {
  translations: {
    en: { imageposition: { "image-position": "Image position" } },
  },
  defaults: {
  ...
  popup: function (t, i) {
    var s = {},
      o = this.opts.imageposition.items;
    for (var e in o)
      o[e] && (s[e] = { name: o[e], icon: this.opts.imageposition.icons[e] });
  ...
  getFloat: function () {
    ...
    var i = this.app.block.get().getBlock(),
      s = "none";
    for (var o in t) i.hasClass(t[o]) && (s = o);
    return { ifloat: s };
  },
  setFloat: function (t) {
    ...
    s.setClassFromObj(this.opts.imageposition.items, i.ifloat),
