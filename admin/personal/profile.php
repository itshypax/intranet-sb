...
} elseif (!in_array('full_admin', $_SESSION['permissions']) && !in_array('admin', $_SESSION['permissions'])) {
    if (in_array('personal_view', $_SESSION['permissions'])) {
        $canView = true;
        $canEdit = in_array('personal_edit', $_SESSION['permissions']);
    } else {
        $canView = false;
        $canEdit = false;
    }
...
<body>
    <!-- NAVIGATION -->
    <nav class="navbar bg-sh-red" id="admin-nav">
        <div class="container-fluid">
            <div class="container">
                <div class="row w-100">
                    <div class="col d-flex align-items-center justify-content-start">
                        <a id="sb-logo" href="#">
                            <svg id="a" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2784.97 526.37" height="70" width="auto" style="transform:scale(.5)">
                                <g id="b">
    ...
    <div class="container-fluid">
        <div class="row">
            <?php include '../../assets/php/admin-nav.php' ?>
            <div class="col mobile-hide"></div>
            <div class="col-6 my-5">
                ...
                ?>
                    <div class="alert alert-info" role="alert">
                        ...
                        <?php if (in_array('full_admin', $_SESSION['permissions']) || in_array('admin', $_SESSION['permissions']) || in_array('users_edit', $_SESSION['permissions'])) { ?>
                    ...
                    <div class="col-5 p-3 shadow-sm border ma-basedata">
                        <form id="profil" method="post">
                            ...
                            <div class="w-100 text-center">
                                <img src="/assets/img/example.png" alt="Benutzerprofil" height="94px" width="auto">
                                <?php if (!isset($_GET['edit']) || !$canEdit) { ?>
                                ...
                                <?php } ?>
                                <?php if (in_array('full_admin', $_SESSION['permissions']) || in_array('admin', $_SESSION['permissions']) || in_array('personal_dokumente', $_SESSION['permissions'])) { ?>
