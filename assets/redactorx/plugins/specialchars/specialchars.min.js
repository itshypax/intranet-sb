RedactorX.add("plugin", "specialchars", {
  translations: {
    en: { specialchars: { "special-chars": "Special Characters" } },
  },
  defaults: {
  ...
  start: function () {
    ...
    this.app.toolbar.add("specialchars", a);
  },
  popup: function (a, e) {
    for (var c = {}, i = this.opts.specialchars.items, r = 0; r < i.length; r++)
      c[r] = {
        html: this.dom("<div>")
          .addClass(this.prefix + "-popup-item")
          .html(i[r]),
        command: "specialchars.insert",
        params: { character: i[r] },
      };
  ...
  insert: function (a) {
    this.app.popup.close(), this.app.insertion.insertHtml(a.character, "after");
  },
});
